...
for (mc in 1:data$para.g.mech) {
  ...
  df_next <- data.frame(
    ...
    outcome = y_value_sc[mc, set_fig1_h, set_fig1_span, set_fig1_connectivity, set_fig1_t]
  )
  ...
  df_next <- data.frame(
    ...
    outcome = y_value_rr[mc, set_fig1_h, set_fig1_span, set_fig1_connectivity, set_fig1_t]
  )
  df_fig1 <- rbind(df_fig1, df_next)
  ...
  df_next <- data.frame(
    ...
    outcome = y_value_nr[mc, set_fig1_h, set_fig1_span, set_fig1_connectivity, set_fig1_t]
  )
  df_fig1 <- rbind(df_fig1, df_next)
}
