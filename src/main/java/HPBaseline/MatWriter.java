...
class MatWriter {
  ...
  MatWriter(Computation c) {
    ...
    try {
      Mat5.newMatFile().addArray("para_is_decomposed", Mat5.newScalar(Main.EXPERIMENT_IS_DECOMPOSITION ? 1 : 0)).addArray("para_w", Mat5.newScalar(Main.WEIGHT_ON_CHARACTERISTIC)).addArray("para_iteration", Mat5.newScalar(Main.ITERATION))
          .addArray("para_iteration_beta", Mat5.newScalar(Main.ITERATION_BETA)).addArray("para_time", Mat5.newScalar(Main.TIME)).addArray("para_n", Mat5.newScalar(Main.N)).addArray("para_n_of_unit", Mat5.newScalar(Main.N_OF_UNIT))
          .addArray("para_n_in_unit", Mat5.newScalar(Main.N_IN_UNIT)).addArray("para_l", Mat5.newScalar(Main.L)).addArray("para_m", Mat5.newScalar(Main.M)).addArray("para_m_of_bundle", Mat5.newScalar(Main.M_OF_BUNDLE))
          .addArray("para_m_in_bundle", Mat5.newScalar(Main.M_IN_BUNDLE))

          .addArray("para_g_h", Mat5.newScalar(Main.LENGTH_H)).addArray("para_g_theta", Mat5.newScalar(Main.GRANULARITY_THETA)).addArray("para_g_beta", Mat5.newScalar(Main.LENGTH_BETA))
          .addArray("para_g_beta_cand", Mat5.newScalar(Main.GRANULARITY_BETA_CANDIDATE)).addArray("para_o_beta", Mat5.newScalar(Main.OPTIMAL_BETA)).addArray("para_o_beta_set_by_user", Mat5.newScalar(Main.GET_OPTIMAL_BETA ? 1 : 0))
          .addArray("para_g_e", Mat5.newScalar(Main.LENGTH_E)).addArray("para_p_learning", Mat5.newScalar(Main.P_LEARNING)).addArray("para_a_h", matrixArrayH).addArray("para_a_theta", matrixArrayTheta)
          .addArray("para_a_beta_cand", matrixArrayBetaCandidate).addArray("para_a_beta", matrixArrayBeta).addArray("para_a_e", matrixArrayE)

          .addArray("r_perf_avg", matrixPerformanceAVG).addArray("r_perf_std", matrixPerformanceSTD).addArray("r_perf_12_avg", matrixPerformance12AVG).addArray("r_perf_12_std", matrixPerformance12STD).addArray("r_perf_23_avg", matrixPerformance23AVG)
          .addArray("r_perf_23_std", matrixPerformance23STD).addArray("r_perf_13_avg", matrixPerformance13AVG).addArray("r_perf_13_std", matrixPerformance13STD)

          .addArray("r_disa_avg", matrixDisagreementAVG).addArray("r_disa_std", matrixDisagreementSTD).addArray("r_disa_12_avg", matrixDisagreement12AVG).addArray("r_disa_12_std", matrixDisagreement12STD)
          .addArray("r_disa_23_avg", matrixDisagreement23AVG).addArray("r_disa_23_std", matrixDisagreement23STD).addArray("r_disa_13_avg", matrixDisagreement13AVG).addArray("r_disa_13_std", matrixDisagreement13STD)

          .addArray("r_diss_avg", matrixDissimilarityAVG).addArray("r_diss_std", matrixDissimilaritySTD).addArray("r_diss_12_avg", matrixDissimilarity12AVG).addArray("r_diss_12_std", matrixDissimilarity12STD)
          .addArray("r_diss_23_avg", matrixDissimilarity23AVG).addArray("r_diss_23_std", matrixDissimilarity23STD).addArray("r_diss_13_avg", matrixDissimilarity13AVG).addArray("r_diss_13_std", matrixDissimilarity13STD)

          .addArray("r_clus_avg", matrixClusteringAVG).addArray("r_clus_std", matrixClusteringSTD).addArray("r_clus_12_avg", matrixClustering12AVG).addArray("r_clus_12_std", matrixClustering12STD).addArray("r_clus_23_avg", matrixClustering23AVG)
          .addArray("r_clus_23_std", matrixClustering23STD).addArray("r_clus_13_avg", matrixClustering13AVG).addArray("r_clus_13_std", matrixClustering13STD)

          .addArray("r_sati_avg", matrixSatisfactionAVG).addArray("r_sati_std", matrixSatisfactionSTD).addArray("r_rewi_avg", matrixRewiringAVG).addArray("r_rewi_std", matrixRewiringSTD)

          .addArray("r_seta_avg", matrixBetaSampledAVG).addArray("r_seta_std", matrixBetaSampledSTD).addArray("perf_seconds", Mat5.newScalar((System.currentTimeMillis() - Main.TIC) / 1000))
  ...
  MatWriter(Decomposition d) {
    ...
    try {
      Mat5.newMatFile().addArray("para_is_decomposed", Mat5.newScalar(Main.EXPERIMENT_IS_DECOMPOSITION ? 1 : 0)).addArray("para_w", Mat5.newScalar(Main.WEIGHT_ON_CHARACTERISTIC)).addArray("para_iteration", Mat5.newScalar(Main.ITERATION))
          ...
          .addArray("para_g_h", Mat5.newScalar(Main.LENGTH_H)).addArray("para_g_beta", Mat5.newScalar(Main.LENGTH_BETA)).addArray("para_g_e", Mat5.newScalar(Main.LENGTH_E)).addArray("para_g_a", Mat5.newScalar(Main.LENGTH_A))
          .addArray("para_g_beta_cand", Mat5.newScalar(Main.GRANULARITY_BETA_CANDIDATE)).addArray("para_o_beta", Mat5.newScalar(Main.OPTIMAL_BETA)).addArray("para_o_beta_set_by_user", Mat5.newScalar(Main.GET_OPTIMAL_BETA ? 1 : 0))
          .addArray("para_p_learning", Mat5.newScalar(Main.P_LEARNING))

          .addArray("para_a_h", matrixArrayH).addArray("para_a_beta", matrixArrayBeta).addArray("para_a_e", matrixArrayE).addArray("para_a_a", matrixArrayA)
