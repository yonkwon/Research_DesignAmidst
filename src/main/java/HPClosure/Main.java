...
//  static final double[] THETA = {.0001, 0.0625, 0.125, 0.1875, 0.25, 0.3125, 0.375, 0.4375, 0.5, .75, .9999};
  static final int LENGTH_THETA = THETA.length;
...
//  static final double[] BETA_CANDIDATE = {.06, .061, .062, .063, .064, .065, .066, .067};
  ...
  static final int LENGTH_BETA_CANDIDATE = BETA_CANDIDATE.length;
...
//  static final double[] C = {0, .25, .5, .75, 1};
  ...
  static final int[] RESULT_KEY_VALUE = {LENGTH_C, LENGTH_THETA, LENGTH_E, TIME};
