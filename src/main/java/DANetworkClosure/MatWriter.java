...
class MatWriter {
  ...
  MatWriter(Computation com) {
          ...
          for (int c = 0; c < Main.LENGTH_CONNECTIVITY; c++) {
            for (int e = 0; e < Main.LENGTH_ENFORCEMENT; e++) {
              for (int t = 0; t < Main.TIME; t++) {
                int[] indices = {d, s, c, e, t};
                matrixPerformanceAVG.setDouble(indices, com.performanceAVG[d][s][c][e][t]);
                matrixPerformanceSTD.setDouble(indices, com.performanceSTD[d][s][c][e][t]);
                matrixPerformanceNRAVG.setDouble(indices, com.performanceNRAVG[d][s][c][e][t]);
                matrixPerformanceNRSTD.setDouble(indices, com.performanceNRSTD[d][s][c][e][t]);
                matrixPerformanceRRAVG.setDouble(indices, com.performanceRRAVG[d][s][c][e][t]);
                matrixPerformanceRRSTD.setDouble(indices, com.performanceRRSTD[d][s][c][e][t]);
                matrixPerformance12AVG.setDouble(indices, com.performance12AVG[d][s][c][e][t]);
                matrixPerformance12STD.setDouble(indices, com.performance12STD[d][s][c][e][t]);
                matrixPerformance23AVG.setDouble(indices, com.performance23AVG[d][s][c][e][t]);
                matrixPerformance23STD.setDouble(indices, com.performance23STD[d][s][c][e][t]);
                matrixPerformance13AVG.setDouble(indices, com.performance13AVG[d][s][c][e][t]);
                matrixPerformance13STD.setDouble(indices, com.performance13STD[d][s][c][e][t]);

                matrixDisagreementAVG.setDouble(indices, com.disagreementAVG[d][s][c][e][t]);
                matrixDisagreementSTD.setDouble(indices, com.disagreementSTD[d][s][c][e][t]);
                matrixDisagreement12AVG.setDouble(indices, com.disagreement12AVG[d][s][c][e][t]);
                matrixDisagreement12STD.setDouble(indices, com.disagreement12STD[d][s][c][e][t]);
                matrixDisagreement23AVG.setDouble(indices, com.disagreement23AVG[d][s][c][e][t]);
                matrixDisagreement23STD.setDouble(indices, com.disagreement23STD[d][s][c][e][t]);
                matrixDisagreement13AVG.setDouble(indices, com.disagreement13AVG[d][s][c][e][t]);
                matrixDisagreement13STD.setDouble(indices, com.disagreement13STD[d][s][c][e][t]);
                matrixDisagreementNRAVG.setDouble(indices, com.disagreementNRAVG[d][s][c][e][t]);
                matrixDisagreementNRSTD.setDouble(indices, com.disagreementNRSTD[d][s][c][e][t]);
                matrixDisagreementRRAVG.setDouble(indices, com.disagreementRRAVG[d][s][c][e][t]);
                matrixDisagreementRRSTD.setDouble(indices, com.disagreementRRSTD[d][s][c][e][t]);

                matrixClusteringAVG.setDouble(indices, com.clusteringAVG[d][s][c][e][t]);
                matrixClusteringSTD.setDouble(indices, com.clusteringSTD[d][s][c][e][t]);
                matrixClustering12AVG.setDouble(indices, com.clustering12AVG[d][s][c][e][t]);
                matrixClustering12STD.setDouble(indices, com.clustering12STD[d][s][c][e][t]);
                matrixClustering23AVG.setDouble(indices, com.clustering23AVG[d][s][c][e][t]);
                matrixClustering23STD.setDouble(indices, com.clustering23STD[d][s][c][e][t]);
                matrixClustering13AVG.setDouble(indices, com.clustering13AVG[d][s][c][e][t]);
                matrixClustering13STD.setDouble(indices, com.clustering13STD[d][s][c][e][t]);
                matrixClusteringNRAVG.setDouble(indices, com.clusteringNRAVG[d][s][c][e][t]);
                matrixClusteringNRSTD.setDouble(indices, com.clusteringNRSTD[d][s][c][e][t]);
                matrixClusteringRRAVG.setDouble(indices, com.clusteringRRAVG[d][s][c][e][t]);
                matrixClusteringRRSTD.setDouble(indices, com.clusteringRRSTD[d][s][c][e][t]);

                matrixClusteringWattsStrogatzAVG.setDouble(indices, com.clusteringWattsStrogatzAVG[d][s][c][e][t]);
                matrixClusteringWattsStrogatzSTD.setDouble(indices, com.clusteringWattsStrogatzSTD[d][s][c][e][t]);
                matrixClusteringWattsStrogatz12AVG.setDouble(indices, com.clusteringWattsStrogatz12AVG[d][s][c][e][t]);
                matrixClusteringWattsStrogatz12STD.setDouble(indices, com.clusteringWattsStrogatz12STD[d][s][c][e][t]);
                matrixClusteringWattsStrogatz23AVG.setDouble(indices, com.clusteringWattsStrogatz23AVG[d][s][c][e][t]);
                matrixClusteringWattsStrogatz23STD.setDouble(indices, com.clusteringWattsStrogatz23STD[d][s][c][e][t]);
                matrixClusteringWattsStrogatz13AVG.setDouble(indices, com.clusteringWattsStrogatz13AVG[d][s][c][e][t]);
                matrixClusteringWattsStrogatz13STD.setDouble(indices, com.clusteringWattsStrogatz13STD[d][s][c][e][t]);
                matrixClusteringWattsStrogatzNRAVG.setDouble(indices, com.clusteringWattsStrogatzNRAVG[d][s][c][e][t]);
                matrixClusteringWattsStrogatzNRSTD.setDouble(indices, com.clusteringWattsStrogatzNRSTD[d][s][c][e][t]);
                matrixClusteringWattsStrogatzRRAVG.setDouble(indices, com.clusteringWattsStrogatzRRAVG[d][s][c][e][t]);
                matrixClusteringWattsStrogatzRRSTD.setDouble(indices, com.clusteringWattsStrogatzRRSTD[d][s][c][e][t]);

                matrixCentralizationAVG.setDouble(indices, com.centralizationAVG[d][s][c][e][t]);
                matrixCentralizationSTD.setDouble(indices, com.centralizationSTD[d][s][c][e][t]);
                matrixCentralization12AVG.setDouble(indices, com.centralization12AVG[d][s][c][e][t]);
                matrixCentralization12STD.setDouble(indices, com.centralization12STD[d][s][c][e][t]);
                matrixCentralization23AVG.setDouble(indices, com.centralization23AVG[d][s][c][e][t]);
                matrixCentralization23STD.setDouble(indices, com.centralization23STD[d][s][c][e][t]);
                matrixCentralization13AVG.setDouble(indices, com.centralization13AVG[d][s][c][e][t]);
                matrixCentralization13STD.setDouble(indices, com.centralization13STD[d][s][c][e][t]);
                matrixCentralizationNRAVG.setDouble(indices, com.centralizationNRAVG[d][s][c][e][t]);
                matrixCentralizationNRSTD.setDouble(indices, com.centralizationNRSTD[d][s][c][e][t]);
                matrixCentralizationRRAVG.setDouble(indices, com.centralizationRRAVG[d][s][c][e][t]);
                matrixCentralizationRRSTD.setDouble(indices, com.centralizationRRSTD[d][s][c][e][t]);

                matrixEfficiencyAVG.setDouble(indices, com.efficiencyAVG[d][s][c][e][t]);
                matrixEfficiencySTD.setDouble(indices, com.efficiencySTD[d][s][c][e][t]);
                matrixEfficiency12AVG.setDouble(indices, com.efficiency12AVG[d][s][c][e][t]);
                matrixEfficiency12STD.setDouble(indices, com.efficiency12STD[d][s][c][e][t]);
                matrixEfficiency23AVG.setDouble(indices, com.efficiency23AVG[d][s][c][e][t]);
                matrixEfficiency23STD.setDouble(indices, com.efficiency23STD[d][s][c][e][t]);
                matrixEfficiency13AVG.setDouble(indices, com.efficiency13AVG[d][s][c][e][t]);
                matrixEfficiency13STD.setDouble(indices, com.efficiency13STD[d][s][c][e][t]);
                matrixEfficiencyNRAVG.setDouble(indices, com.efficiencyNRAVG[d][s][c][e][t]);
                matrixEfficiencyNRSTD.setDouble(indices, com.efficiencyNRSTD[d][s][c][e][t]);
                matrixEfficiencyRRAVG.setDouble(indices, com.efficiencyRRAVG[d][s][c][e][t]);
                matrixEfficiencyRRSTD.setDouble(indices, com.efficiencyRRSTD[d][s][c][e][t]);

                matrixDistanceAVG.setDouble(indices, com.distanceAVG[d][s][c][e][t]);
                matrixDistanceSTD.setDouble(indices, com.distanceSTD[d][s][c][e][t]);
                matrixDistance12AVG.setDouble(indices, com.distance12AVG[d][s][c][e][t]);
                matrixDistance12STD.setDouble(indices, com.distance12STD[d][s][c][e][t]);
                matrixDistance23AVG.setDouble(indices, com.distance23AVG[d][s][c][e][t]);
                matrixDistance23STD.setDouble(indices, com.distance23STD[d][s][c][e][t]);
                matrixDistance13AVG.setDouble(indices, com.distance13AVG[d][s][c][e][t]);
                matrixDistance13STD.setDouble(indices, com.distance13STD[d][s][c][e][t]);
                matrixDistanceNRAVG.setDouble(indices, com.distanceNRAVG[d][s][c][e][t]);
                matrixDistanceNRSTD.setDouble(indices, com.distanceNRSTD[d][s][c][e][t]);
                matrixDistanceRRAVG.setDouble(indices, com.distanceRRAVG[d][s][c][e][t]);
                matrixDistanceRRSTD.setDouble(indices, com.distanceRRSTD[d][s][c][e][t]);

                matrixDensityAVG.setDouble(indices, com.densityAVG[d][s][c][e][t]);
                matrixDensitySTD.setDouble(indices, com.densitySTD[d][s][c][e][t]);
                matrixDensity12AVG.setDouble(indices, com.density12AVG[d][s][c][e][t]);
                matrixDensity12STD.setDouble(indices, com.density12STD[d][s][c][e][t]);
                matrixDensity23AVG.setDouble(indices, com.density23AVG[d][s][c][e][t]);
                matrixDensity23STD.setDouble(indices, com.density23STD[d][s][c][e][t]);
                matrixDensity13AVG.setDouble(indices, com.density13AVG[d][s][c][e][t]);
                matrixDensity13STD.setDouble(indices, com.density13STD[d][s][c][e][t]);
                matrixDensityNRAVG.setDouble(indices, com.densityNRAVG[d][s][c][e][t]);
                matrixDensityNRSTD.setDouble(indices, com.densityNRSTD[d][s][c][e][t]);
                matrixDensityRRAVG.setDouble(indices, com.densityRRAVG[d][s][c][e][t]);
                matrixDensityRRSTD.setDouble(indices, com.densityRRSTD[d][s][c][e][t]);

                matrixBetweennessCentralityVarianceAVG.setDouble(indices, com.betweennessCentralityVarianceAVG[d][s][c][e][t]);
                matrixBetweennessCentralityVarianceSTD.setDouble(indices, com.betweennessCentralityVarianceSTD[d][s][c][e][t]);
                matrixBetweennessCentralityVariance12AVG.setDouble(indices, com.betweennessCentralityVariance12AVG[d][s][c][e][t]);
                matrixBetweennessCentralityVariance12STD.setDouble(indices, com.betweennessCentralityVariance12STD[d][s][c][e][t]);
                matrixBetweennessCentralityVariance23AVG.setDouble(indices, com.betweennessCentralityVariance23AVG[d][s][c][e][t]);
                matrixBetweennessCentralityVariance23STD.setDouble(indices, com.betweennessCentralityVariance23STD[d][s][c][e][t]);
                matrixBetweennessCentralityVariance13AVG.setDouble(indices, com.betweennessCentralityVariance13AVG[d][s][c][e][t]);
                matrixBetweennessCentralityVariance13STD.setDouble(indices, com.betweennessCentralityVariance13STD[d][s][c][e][t]);
                matrixBetweennessCentralityVarianceNRAVG.setDouble(indices, com.betweennessCentralityVarianceNRAVG[d][s][c][e][t]);
                matrixBetweennessCentralityVarianceNRSTD.setDouble(indices, com.betweennessCentralityVarianceNRSTD[d][s][c][e][t]);
                matrixBetweennessCentralityVarianceRRAVG.setDouble(indices, com.betweennessCentralityVarianceRRAVG[d][s][c][e][t]);
                matrixBetweennessCentralityVarianceRRSTD.setDouble(indices, com.betweennessCentralityVarianceRRSTD[d][s][c][e][t]);

                matrixSatisfactionAVG.setDouble(indices, com.satisfactionAVG[d][s][c][e][t]);
                matrixSatisfactionSTD.setDouble(indices, com.satisfactionSTD[d][s][c][e][t]);

                matrixRewiringAVG.setDouble(indices, com.rewiringAVG[d][s][c][e][t]);
                matrixRewiringSTD.setDouble(indices, com.rewiringSTD[d][s][c][e][t]);
                
                matrixRewiringCumulativeAVG.setDouble(indices, com.rewiringCumulativeAVG[d][s][c][e][t]);
                matrixRewiringCumulativeSTD.setDouble(indices, com.rewiringCumulativeSTD[d][s][c][e][t]);
              }
            }
          }
        }
    ...
    Matrix matrixArrayDegree = Mat5.newMatrix(new int[]{1, Main.LENGTH_DEGREE});
    IntStream.range(0, Main.LENGTH_DEGREE).forEach(i -> matrixArrayDegree.setDouble(new int[]{0, i}, Main.DEGREE[i]));
    ...
    try {
      Mat5.newMatFile()
          ...
          .addArray("para_g_mech", Mat5.newScalar(Main.LENGTH_DEGREE))
          ...
          .addArray("para_g_dgre", Mat5.newScalar(Main.LENGTH_DEGREE))
          .addArray("para_a_dgre", matrixArrayDegree)
