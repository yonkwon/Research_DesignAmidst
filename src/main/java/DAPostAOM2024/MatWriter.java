          ...
          for (int c = 0; c < Main.LENGTH_CONNECTIVITY; c++) {
            for (int e = 0; e < Main.LENGTH_ENFORCEMENT; e++) {
              for (int t = 0; t < Main.TIME; t++) {
                int[] indices = {mc, s, c, e, t};
                matrixPerformanceAVG.setDouble(indices, d.performanceAVG[mc][s][c][e][t]);
                matrixPerformanceSTD.setDouble(indices, d.performanceSTD[mc][s][c][e][t]);
                matrixPerformanceNRAVG.setDouble(indices, d.performanceNRAVG[mc][s][c][e][t]);
                matrixPerformanceNRSTD.setDouble(indices, d.performanceNRSTD[mc][s][c][e][t]);
                matrixPerformanceRRAVG.setDouble(indices, d.performanceRRAVG[mc][s][c][e][t]);
                matrixPerformanceRRSTD.setDouble(indices, d.performanceRRSTD[mc][s][c][e][t]);
                matrixPerformance12AVG.setDouble(indices, d.performance12AVG[mc][s][c][e][t]);
                matrixPerformance12STD.setDouble(indices, d.performance12STD[mc][s][c][e][t]);
                matrixPerformance23AVG.setDouble(indices, d.performance23AVG[mc][s][c][e][t]);
                matrixPerformance23STD.setDouble(indices, d.performance23STD[mc][s][c][e][t]);
                matrixPerformance13AVG.setDouble(indices, d.performance13AVG[mc][s][c][e][t]);
                matrixPerformance13STD.setDouble(indices, d.performance13STD[mc][s][c][e][t]);

                matrixDisagreementAVG.setDouble(indices, d.disagreementAVG[mc][s][c][e][t]);
                matrixDisagreementSTD.setDouble(indices, d.disagreementSTD[mc][s][c][e][t]);
                matrixDisagreement12AVG.setDouble(indices, d.disagreement12AVG[mc][s][c][e][t]);
                matrixDisagreement12STD.setDouble(indices, d.disagreement12STD[mc][s][c][e][t]);
                matrixDisagreement23AVG.setDouble(indices, d.disagreement23AVG[mc][s][c][e][t]);
                matrixDisagreement23STD.setDouble(indices, d.disagreement23STD[mc][s][c][e][t]);
                matrixDisagreement13AVG.setDouble(indices, d.disagreement13AVG[mc][s][c][e][t]);
                matrixDisagreement13STD.setDouble(indices, d.disagreement13STD[mc][s][c][e][t]);
                matrixDisagreementNRAVG.setDouble(indices, d.disagreementNRAVG[mc][s][c][e][t]);
                matrixDisagreementNRSTD.setDouble(indices, d.disagreementNRSTD[mc][s][c][e][t]);
                matrixDisagreementRRAVG.setDouble(indices, d.disagreementRRAVG[mc][s][c][e][t]);
                matrixDisagreementRRSTD.setDouble(indices, d.disagreementRRSTD[mc][s][c][e][t]);

                matrixClusteringAVG.setDouble(indices, d.clusteringAVG[mc][s][c][e][t]);
                matrixClusteringSTD.setDouble(indices, d.clusteringSTD[mc][s][c][e][t]);
                matrixClustering12AVG.setDouble(indices, d.clustering12AVG[mc][s][c][e][t]);
                matrixClustering12STD.setDouble(indices, d.clustering12STD[mc][s][c][e][t]);
                matrixClustering23AVG.setDouble(indices, d.clustering23AVG[mc][s][c][e][t]);
                matrixClustering23STD.setDouble(indices, d.clustering23STD[mc][s][c][e][t]);
                matrixClustering13AVG.setDouble(indices, d.clustering13AVG[mc][s][c][e][t]);
                matrixClustering13STD.setDouble(indices, d.clustering13STD[mc][s][c][e][t]);
                matrixClusteringNRAVG.setDouble(indices, d.clusteringNRAVG[mc][s][c][e][t]);
                matrixClusteringNRSTD.setDouble(indices, d.clusteringNRSTD[mc][s][c][e][t]);
                matrixClusteringRRAVG.setDouble(indices, d.clusteringRRAVG[mc][s][c][e][t]);
                matrixClusteringRRSTD.setDouble(indices, d.clusteringRRSTD[mc][s][c][e][t]);

                matrixClusteringWattsStrogatzAVG.setDouble(indices, d.clusteringWattsStrogatzAVG[mc][s][c][e][t]);
                matrixClusteringWattsStrogatzSTD.setDouble(indices, d.clusteringWattsStrogatzSTD[mc][s][c][e][t]);
                matrixClusteringWattsStrogatz12AVG.setDouble(indices, d.clusteringWattsStrogatz12AVG[mc][s][c][e][t]);
                matrixClusteringWattsStrogatz12STD.setDouble(indices, d.clusteringWattsStrogatz12STD[mc][s][c][e][t]);
                matrixClusteringWattsStrogatz23AVG.setDouble(indices, d.clusteringWattsStrogatz23AVG[mc][s][c][e][t]);
                matrixClusteringWattsStrogatz23STD.setDouble(indices, d.clusteringWattsStrogatz23STD[mc][s][c][e][t]);
                matrixClusteringWattsStrogatz13AVG.setDouble(indices, d.clusteringWattsStrogatz13AVG[mc][s][c][e][t]);
                matrixClusteringWattsStrogatz13STD.setDouble(indices, d.clusteringWattsStrogatz13STD[mc][s][c][e][t]);
                matrixClusteringWattsStrogatzNRAVG.setDouble(indices, d.clusteringWattsStrogatzNRAVG[mc][s][c][e][t]);
                matrixClusteringWattsStrogatzNRSTD.setDouble(indices, d.clusteringWattsStrogatzNRSTD[mc][s][c][e][t]);
                matrixClusteringWattsStrogatzRRAVG.setDouble(indices, d.clusteringWattsStrogatzRRAVG[mc][s][c][e][t]);
                matrixClusteringWattsStrogatzRRSTD.setDouble(indices, d.clusteringWattsStrogatzRRSTD[mc][s][c][e][t]);

                matrixCentralizationAVG.setDouble(indices, d.centralizationAVG[mc][s][c][e][t]);
                matrixCentralizationSTD.setDouble(indices, d.centralizationSTD[mc][s][c][e][t]);
                matrixCentralization12AVG.setDouble(indices, d.centralization12AVG[mc][s][c][e][t]);
                matrixCentralization12STD.setDouble(indices, d.centralization12STD[mc][s][c][e][t]);
                matrixCentralization23AVG.setDouble(indices, d.centralization23AVG[mc][s][c][e][t]);
                matrixCentralization23STD.setDouble(indices, d.centralization23STD[mc][s][c][e][t]);
                matrixCentralization13AVG.setDouble(indices, d.centralization13AVG[mc][s][c][e][t]);
                matrixCentralization13STD.setDouble(indices, d.centralization13STD[mc][s][c][e][t]);
                matrixCentralizationNRAVG.setDouble(indices, d.centralizationNRAVG[mc][s][c][e][t]);
                matrixCentralizationNRSTD.setDouble(indices, d.centralizationNRSTD[mc][s][c][e][t]);
                matrixCentralizationRRAVG.setDouble(indices, d.centralizationRRAVG[mc][s][c][e][t]);
                matrixCentralizationRRSTD.setDouble(indices, d.centralizationRRSTD[mc][s][c][e][t]);

                matrixEfficiencyAVG.setDouble(indices, d.efficiencyAVG[mc][s][c][e][t]);
                matrixEfficiencySTD.setDouble(indices, d.efficiencySTD[mc][s][c][e][t]);
                matrixEfficiency12AVG.setDouble(indices, d.efficiency12AVG[mc][s][c][e][t]);
                matrixEfficiency12STD.setDouble(indices, d.efficiency12STD[mc][s][c][e][t]);
                matrixEfficiency23AVG.setDouble(indices, d.efficiency23AVG[mc][s][c][e][t]);
                matrixEfficiency23STD.setDouble(indices, d.efficiency23STD[mc][s][c][e][t]);
                matrixEfficiency13AVG.setDouble(indices, d.efficiency13AVG[mc][s][c][e][t]);
                matrixEfficiency13STD.setDouble(indices, d.efficiency13STD[mc][s][c][e][t]);
                matrixEfficiencyNRAVG.setDouble(indices, d.efficiencyNRAVG[mc][s][c][e][t]);
                matrixEfficiencyNRSTD.setDouble(indices, d.efficiencyNRSTD[mc][s][c][e][t]);
                matrixEfficiencyRRAVG.setDouble(indices, d.efficiencyRRAVG[mc][s][c][e][t]);
                matrixEfficiencyRRSTD.setDouble(indices, d.efficiencyRRSTD[mc][s][c][e][t]);

                matrixDistanceAVG.setDouble(indices, d.distanceAVG[mc][s][c][e][t]);
                matrixDistanceSTD.setDouble(indices, d.distanceSTD[mc][s][c][e][t]);
                matrixDistance12AVG.setDouble(indices, d.distance12AVG[mc][s][c][e][t]);
                matrixDistance12STD.setDouble(indices, d.distance12STD[mc][s][c][e][t]);
                matrixDistance23AVG.setDouble(indices, d.distance23AVG[mc][s][c][e][t]);
                matrixDistance23STD.setDouble(indices, d.distance23STD[mc][s][c][e][t]);
                matrixDistance13AVG.setDouble(indices, d.distance13AVG[mc][s][c][e][t]);
                matrixDistance13STD.setDouble(indices, d.distance13STD[mc][s][c][e][t]);
                matrixDistanceNRAVG.setDouble(indices, d.distanceNRAVG[mc][s][c][e][t]);
                matrixDistanceNRSTD.setDouble(indices, d.distanceNRSTD[mc][s][c][e][t]);
                matrixDistanceRRAVG.setDouble(indices, d.distanceRRAVG[mc][s][c][e][t]);
                matrixDistanceRRSTD.setDouble(indices, d.distanceRRSTD[mc][s][c][e][t]);

                matrixDensityAVG.setDouble(indices, d.densityAVG[mc][s][c][e][t]);
                matrixDensitySTD.setDouble(indices, d.densitySTD[mc][s][c][e][t]);
                matrixDensity12AVG.setDouble(indices, d.density12AVG[mc][s][c][e][t]);
                matrixDensity12STD.setDouble(indices, d.density12STD[mc][s][c][e][t]);
                matrixDensity23AVG.setDouble(indices, d.density23AVG[mc][s][c][e][t]);
                matrixDensity23STD.setDouble(indices, d.density23STD[mc][s][c][e][t]);
                matrixDensity13AVG.setDouble(indices, d.density13AVG[mc][s][c][e][t]);
                matrixDensity13STD.setDouble(indices, d.density13STD[mc][s][c][e][t]);
                matrixDensityNRAVG.setDouble(indices, d.densityNRAVG[mc][s][c][e][t]);
                matrixDensityNRSTD.setDouble(indices, d.densityNRSTD[mc][s][c][e][t]);
                matrixDensityRRAVG.setDouble(indices, d.densityRRAVG[mc][s][c][e][t]);
                matrixDensityRRSTD.setDouble(indices, d.densityRRSTD[mc][s][c][e][t]);

                matrixBetweennessCentralityVarianceAVG.setDouble(indices, d.betweennessCentralityVarianceAVG[mc][s][c][e][t]);
                matrixBetweennessCentralityVarianceSTD.setDouble(indices, d.betweennessCentralityVarianceSTD[mc][s][c][e][t]);
                matrixBetweennessCentralityVariance12AVG.setDouble(indices, d.betweennessCentralityVariance12AVG[mc][s][c][e][t]);
                matrixBetweennessCentralityVariance12STD.setDouble(indices, d.betweennessCentralityVariance12STD[mc][s][c][e][t]);
                matrixBetweennessCentralityVariance23AVG.setDouble(indices, d.betweennessCentralityVariance23AVG[mc][s][c][e][t]);
                matrixBetweennessCentralityVariance23STD.setDouble(indices, d.betweennessCentralityVariance23STD[mc][s][c][e][t]);
                matrixBetweennessCentralityVariance13AVG.setDouble(indices, d.betweennessCentralityVariance13AVG[mc][s][c][e][t]);
                matrixBetweennessCentralityVariance13STD.setDouble(indices, d.betweennessCentralityVariance13STD[mc][s][c][e][t]);
                matrixBetweennessCentralityVarianceNRAVG.setDouble(indices, d.betweennessCentralityVarianceNRAVG[mc][s][c][e][t]);
                matrixBetweennessCentralityVarianceNRSTD.setDouble(indices, d.betweennessCentralityVarianceNRSTD[mc][s][c][e][t]);
                matrixBetweennessCentralityVarianceRRAVG.setDouble(indices, d.betweennessCentralityVarianceRRAVG[mc][s][c][e][t]);
                matrixBetweennessCentralityVarianceRRSTD.setDouble(indices, d.betweennessCentralityVarianceRRSTD[mc][s][c][e][t]);

                matrixSatisfactionAVG.setDouble(indices, d.satisfactionAVG[mc][s][c][e][t]);
                matrixSatisfactionSTD.setDouble(indices, d.satisfactionSTD[mc][s][c][e][t]);

                matrixRewiringAVG.setDouble(indices, d.rewiringAVG[mc][s][c][e][t]);
                matrixRewiringSTD.setDouble(indices, d.rewiringSTD[mc][s][c][e][t]);
                
                matrixRewiringCumulativeAVG.setDouble(indices, d.rewiringCumulativeAVG[mc][s][c][e][t]);
                matrixRewiringCumulativeSTD.setDouble(indices, d.rewiringCumulativeSTD[mc][s][c][e][t]);
              }
            }
          }
        }
