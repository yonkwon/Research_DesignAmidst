...
set_fig1_h <- 1
set_fig1_span <- data$para.a.span
...
fig1 <- ggplot(data = df_fig1, mapping = axes) +
  ...
  scale_linetype_manual(values = c('solid', 'dotted', 'dashed'), labels = parse_format()) +
  theme_bw()+
  theme(
    text=element_text(
...
ggsave(
  paste0(fig_id, '_',
         ...
         'e', paste0(data$para.a.e[set_fig1_e], collapse = ","),
         't', set_fig1_t,
         '.png'
         ),
  plot = fig1,
