...
for (mech in set_fig_mech) {
  df_next <- data.frame(
    ...
    span_opt = data$para.a.span[which.max(y_value_nr[mech, set_fig_span, set_fig_enforcement, set_fig_turbulence, set_fig_turnover, set_fig_t])],
  ...
  df_next <- data.frame(
    ...
    span_opt = data$para.a.span[which.max(y_value_sc[mech, set_fig_span, set_fig_enforcement, set_fig_turbulence, set_fig_turnover, set_fig_t])],
  ...
  df_next <- data.frame(
    ...
    span_opt = data$para.a.span[which.max(y_value_rr[mech, set_fig_span, set_fig_enforcement, set_fig_turbulence, set_fig_turnover, set_fig_t])],
...
ggsave(
  paste0(
    ...
    set_fig_t_end,
    "turb",
    data$para.a.turb.r[set_fig_turbulence], 
    "@", data$para.a.turb.i[set_fig_turbulence], 
    "turn",
    data$para.a.turn[set_fig_turnover], 
    ".png"
  ),
  plot = fig,
  units = "in",
